package ar.com.marete.webapi.conf;
...
import ar.com.marete.webapi.filters.FiltroLogin;
...
public class WebSecurity extends WebSecurityConfigurerAdapter{
	...
	protected void configure(AuthenticationManagerBuilder auth) throws Exception {
		...
		auth.inMemoryAuthentication().withUser("mario").password(codificador.encode("miclave")).roles("ADMINISTRADOR");
	}
